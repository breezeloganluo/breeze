	...
	<div class="modal-dialog" style="min-width:1000px">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<input type="button" class="btn btn-success btn-lg btn-rect" value="确认提交" title="确认提交" onClick="var args=['singleButton'];var app = FW.getAPP('data\\.configuration');app.FireEvent.saveAddNew.apply(app,args);">
