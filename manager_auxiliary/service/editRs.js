...
define(function(require, exports, module) {
    ...
    FW.register({
        ...
        "param": {
            ...
            *@description 默认的模板
            */
            "fileUrl": "./manager_auxiliary/template/templateRs.js",
            /**
            *@memberOf editRs
            *@name maskid
            *@description 蒙版层的id
            ...
            */
            "contructCssText": function(cssText) {
                ...
                var define = function(f) {
                    var require = function(dir) {
                        if (/BreezeFW/i.test(dir)) {
                            return {
                                regResource: function(r) {
                                    rs = r;
                                }
                            }
                        }
                ...
                eval(cssText);
                //调用父类的app直接刷新左边菜单，增加tpl
                if (this.MY.parent) {
                    parent.FW.getApp("htmledit").addTplMenu(rs);
                }
                return this.MY.page;
            },
            /**
